      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div class="w-full lg:w-80 bg-white p-6 rounded-lg shadow">
            ...
            <!-- Search Box -->
            <div class="mb-6">
              <h3 class="font-medium text-base mb-3">Search Products</h3>
              <div class="relative">
                <input 
                  type="text" 
                  v-model="searchQuery" 
                  placeholder="Search dental products..." 
                  class="w-full border border-gray-300 rounded px-4 py-2 pl-10 focus:ring-blue-500 focus:border-blue-500"
                  @input="applyFilters"
                >
